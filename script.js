...
function renderizarNoticia(noticia){
    const templateNoticia = `
        ...
        <div><img src=${noticia.imgUrl} alt=""></div>
        <div>
            <div></div>
        <div><a href=""></a></div>
        </div>
    ...
    const contenedorNoticiasNacionales = document.querySelector('main section div.noticias-principales .noticias-nacionales');
    const contenedorNoticiasInternacionales = document.querySelector('main section .noticias-internacionales');
...
function agregarNoticia() {
    ...
    const imagenNuevaNoticia = prompt('Ingrese el url de la imagen de la noticia entre comillas: ');
    nuevaNoticia.imgUrl = imagenNuevaNoticia;

    const tipoNuevaNoticia = prompt('¿Es una noticia Nacional? Escriba "true" ó "false"');
